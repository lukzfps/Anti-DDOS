...
#------------------------------------------------------------------------------
RLIMIT="-m limit --limit 20/s --limit-burst 12"
...
$IPTABLES  -A INPUT -p icmp -m limit --limit 15/s --limit-burst 7 -j ACCEPT
$IPTABLES  -A INPUT -p icmp -m limit --limit 15/s --limit-burst 7 -j LOG --log-prefix PING-DROP:
...
$IPTABLES -A SYN_FLOOD -m limit --limit 8/s --limit-burst 8 -j RETURN
